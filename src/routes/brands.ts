...
router.post('/brands/:brandId/belongs-to-company/:companyId', BrandController.createBelongsToCompanyRelation)
router.get('/brands/:brandId/belongs-to-company', BrandController.getBelongsToCompanyRelation)
router.delete('/brands/:brandId/belongs-to-company/:companyId', BrandController.deleteBelongsToCompanyRelation)
