...
router.delete('/magazine-issues/:magazineIssueId/reviewed-car-model-variant-with-rating/:ratingId', MagazineIssueController.deleteReviewedCarModelVariantWithRatingRelation)
