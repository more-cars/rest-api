...
export function mapDbNodeTypeToNodeType(nodeType: DbNodeType): NodeType {
    const mapping = new Map<DbNodeType, NodeType>([
        ...
        [DbNodeType.Price, NodeType.Price],
        ...
        [DbNodeType.ModelCar, NodeType.ModelCar],
        [DbNodeType.ModelCarBrand, NodeType.ModelCarBrand],
        [DbNodeType.Magazine, NodeType.Magazine],
        [DbNodeType.MagazineIssue, NodeType.MagazineIssue],
        ...
        [DbNodeType.Book, NodeType.Book],
        [DbNodeType.Image, NodeType.Image],
        [DbNodeType.Video, NodeType.Video],
        [DbNodeType.Revision, NodeType.Revision],
    ])
