...
export function getDbRelationshipType(relationshipType: RelationshipType): DbRelationship {
    const mapping = new Map<RelationshipType, DbRelationship>([
        ...
        [RelationshipType.CarModelHasVariant, DbRelationship.CarModelHasVariant],
        ...
        [RelationshipType.CarModelVariantIsFeaturedInRacingGame, DbRelationship.CarModelVariantIsFeaturedInRacingGame],
        [RelationshipType.CarModelVariantHasImage, DbRelationship.CarModelVariantHasImage],
        [RelationshipType.CarModelVariantHasPrimeImage, DbRelationship.CarModelVariantHasPrimeImage],
        ...
        [RelationshipType.SessionResultAchievedWithCarModelVariant, DbRelationship.SessionResultAchievedWithCarModelVariant],
        ...
        [RelationshipType.LapTimeAchievedWithCarModelVariant, DbRelationship.LapTimeAchievedWithCarModelVariant],
        ...
        [RelationshipType.GamingPlatformHasImage, DbRelationship.GamingPlatformHasImage],
        [RelationshipType.GamingPlatformHasPrimeImage, DbRelationship.GamingPlatformHasPrimeImage],
