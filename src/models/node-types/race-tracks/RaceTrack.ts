...
export const RaceTrack = {
    ...
    async findById(id: number): Promise<RaceTrackNode> {
    ...
    async update(id: number, data: RaceTrackInput): Promise<RaceTrackNode> {
        const node = await getNodeById(id)
    ...
    async createHasLayoutRelationship(raceTrackId: number, trackLayoutId: number) {
        ...
        await deleteIncomingRel(trackLayoutId, RelType.RaceTrackHasLayout)
    ...
    async createHostedRacingEventRelationship(raceTrackId: number, racingEventId: number) {
        ...
        await deleteIncomingRel(racingEventId, RelType.RaceTrackHostedRacingEvent)
