...
export const RacingSession = {
    async create(data: CreateRacingSessionInput): Promise<RacingSessionNode> {
        ...
        return convertRacingSessionDbNodeToModelNode(result)
    },
    ...
    async createBelongsToRacingEventRelationship(racingSessionId: number, racingEventId: number) {
        ...
        await deleteOutgoingRel(racingSessionId, RelType.RacingSessionBelongsToRacingEvent, DbNodeType.RacingEvent)
    ...
    async createHasSessionResultRelationship(racingSessionId: number, sessionResultId: number) {
        ...
        await deleteIncomingRel(sessionResultId, RelType.RacingSessionHasSessionResult, DbNodeType.RacingSession)
    ...
    async createHasPrimeImageRelationship(racingSessionId: number, imageId: number) {
        ...
        await deleteOutgoingRel(racingSessionId, RelType.RacingSessionHasPrimeImage, DbNodeType.Image)
