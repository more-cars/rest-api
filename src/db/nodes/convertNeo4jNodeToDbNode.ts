...
import {convertModelCarNeo4jNodeToDbNode} from "../node-types/model-cars/convertModelCarNeo4jNodeToDbNode"
import {convertModelCarBrandNeo4jNodeToDbNode} from "../node-types/model-car-brands/convertModelCarBrandNeo4jNodeToDbNode"
...
export function convertNeo4jNodeToDbNode(neo4jNode: Node, nodeTypeLabel: Neo4jNodeType) {
    const mapping = new Map<Neo4jNodeType, (neo4jNode: Node) => void>([
        ...
        [Neo4jNodeType.ModelCar, convertModelCarNeo4jNodeToDbNode],
        [Neo4jNodeType.ModelCarBrand, convertModelCarBrandNeo4jNodeToDbNode],
