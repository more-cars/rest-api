...
async function createDbNode(data: InputImageCreate): Promise<Node> {
    ...
    let augmentedDbNode = await addMoreCarsIdToNode(elementId, moreCarsId, NodeTypeLabel.Image, driver)
