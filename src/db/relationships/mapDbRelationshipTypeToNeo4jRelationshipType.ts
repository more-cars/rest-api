...
export function mapDbRelationshipTypeToNeo4jRelationshipType(
    ...
    const mapping = new Map<RelationshipType, RelationshipTypeNeo4j>([
        ...
        [RelationshipType.CarModelVariantIsCoveredByBook, RelationshipTypeNeo4j.CarModelVariantIsCoveredByBook],
        ...
        [RelationshipType.ModelCarHasVideo, RelationshipTypeNeo4j.ModelCarHasVideo],
        [RelationshipType.ModelCarHasMainVideo, RelationshipTypeNeo4j.ModelCarHasMainVideo],
        ...
        [RelationshipType.ModelCarBrandHasVideo, RelationshipTypeNeo4j.ModelCarBrandHasVideo],
        [RelationshipType.ModelCarBrandHasMainVideo, RelationshipTypeNeo4j.ModelCarBrandHasMainVideo],
        ...
        [RelationshipType.MagazineHasVideo, RelationshipTypeNeo4j.MagazineHasVideo],
        [RelationshipType.MagazineHasMainVideo, RelationshipTypeNeo4j.MagazineHasMainVideo],
        ...
        [RelationshipType.MagazineIssueDocumentsLapTime, RelationshipTypeNeo4j.MagazineIssueDocumentsLapTime],
        ...
        [RelationshipType.MagazineIssueHasVideo, RelationshipTypeNeo4j.MagazineIssueHasVideo],
        [RelationshipType.MagazineIssueHasMainVideo, RelationshipTypeNeo4j.MagazineIssueHasMainVideo],
        ...
        [RelationshipType.ProgrammeEpisodeHasVideo, RelationshipTypeNeo4j.ProgrammeEpisodeHasVideo],
        [RelationshipType.ProgrammeEpisodeHasMainVideo, RelationshipTypeNeo4j.ProgrammeEpisodeHasMainVideo],
        ...
        [RelationshipType.BookHasImage, RelationshipTypeNeo4j.BookHasImage],
        [RelationshipType.BookHasPrimeImage, RelationshipTypeNeo4j.BookHasPrimeImage],
        [RelationshipType.BookHasVideo, RelationshipTypeNeo4j.BookHasVideo],
        [RelationshipType.BookHasMainVideo, RelationshipTypeNeo4j.BookHasMainVideo],
