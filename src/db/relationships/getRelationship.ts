...
export function getRelationshipQuery(startNodeId: number, relationshipName: RelationshipTypeNeo4j, endNodeLabel: Neo4jNodeType, reverse: RelationshipDirection) {
