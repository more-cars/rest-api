...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await SessionResult.getHasPrimeImageRelationship(sessionResultId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.SessionResult, sessionResultId, RelationType.SessionResultHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
