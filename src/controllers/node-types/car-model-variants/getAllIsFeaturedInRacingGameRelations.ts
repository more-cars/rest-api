...
export async function getAllIsFeaturedInRacingGameRelations(req: express.Request, res: express.Response) {
    ...
    try {
        ...
        const marshalledData = marshalRelations(relations, ControllerNodeType.CarModelVariant, carModelVariantId, RelationType.CarModelVariantIsFeaturedInRacingGame)
