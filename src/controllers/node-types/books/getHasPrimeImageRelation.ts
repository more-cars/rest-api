...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Book.getHasPrimeImageRelationship(bookId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Book, bookId, RelationType.BookHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
