...
export async function getAll(req: express.Request, res: express.Response) {
    try {
        const params = extractCollectionConstraintParameters(req, getNodeTypeSpecification(NodeType.Company))
        ...
        const totalAmount = await Node.getTotalAmount(mapControllerNodeTypeToModelNodeType(ControllerNodeType.Company), params)
        const marshalledData = marshalNodeCollection(ControllerNodeType.Company, nodes, params, totalAmount)
