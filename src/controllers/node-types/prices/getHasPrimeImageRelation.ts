...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Price.getHasPrimeImageRelationship(priceId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Price, priceId, RelationType.PriceHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
