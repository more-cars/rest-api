...
export async function getHasMainVideoRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await MotorShow.getHasMainVideoRelationship(motorShowId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.MotorShow, motorShowId, RelationType.MotorShowHasMainVideo)
            return sendResponse200(marshalledData, res)
        } else {
