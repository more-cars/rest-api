...
export async function getHasMainVideoRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await LapTime.getHasMainVideoRelationship(lapTimeId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.LapTime, lapTimeId, RelationType.LapTimeHasMainVideo)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
