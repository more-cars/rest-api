...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await LapTime.getHasPrimeImageRelationship(lapTimeId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.LapTime, lapTimeId, RelationType.LapTimeHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
