...
import {deleteHasScaleModelRelation} from "./car-model-variants/deleteHasScaleModelRelation"
...
export const CarModelVariantController = {
    ...
    async createFeaturedInProgrammeEpisodeRelation(req: express.Request, res: express.Response) {
        await createFeaturedInProgrammeEpisodeRelation(req, res)
    },
    ...
    async deleteHasScaleModelRelation(req: express.Request, res: express.Response) {
        await deleteHasScaleModelRelation(req, res)
    },
    ...
    async createHasPriceRelation(req: express.Request, res: express.Response) {
        await createHasPriceRelation(req, res)
    },

    async getAllHasPriceRelations(req: express.Request, res: express.Response) {
        await getAllHasPriceRelations(req, res)
    },
