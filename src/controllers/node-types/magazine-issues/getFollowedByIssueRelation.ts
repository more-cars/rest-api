...
export async function getFollowedByIssueRelation(req: express.Request, res: express.Response) {
    const magazineIssueId = parseInt(req.params.magazineIssueId)

    try {
        const modelRelation = await MagazineIssue.getFollowedByIssueRelationship(magazineIssueId)
