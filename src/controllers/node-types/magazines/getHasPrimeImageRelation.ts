...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Magazine.getHasPrimeImageRelationship(magazineId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Magazine, magazineId, RelationType.MagazineHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
