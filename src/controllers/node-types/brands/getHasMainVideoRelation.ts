...
export async function getHasMainVideoRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Brand.getHasMainVideoRelationship(brandId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Brand, brandId, RelationType.BrandHasMainVideo)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
