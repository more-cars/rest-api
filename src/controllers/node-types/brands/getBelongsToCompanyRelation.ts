...
export async function getBelongsToCompanyRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Brand.getBelongsToCompanyRelationship(brandId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Brand, brandId, RelationType.BrandBelongsToCompany)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
