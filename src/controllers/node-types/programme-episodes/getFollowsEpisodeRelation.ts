...
export async function getFollowsEpisodeRelation(req: express.Request, res: express.Response) {
    const programmeEpisodeId = parseInt(req.params.programmeEpisodeId)

    try {
        const modelRelation = await ProgrammeEpisode.getFollowsEpisodeRelationship(programmeEpisodeId)
