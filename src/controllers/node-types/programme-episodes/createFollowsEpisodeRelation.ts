...
export async function createFollowsEpisodeRelation(req: express.Request, res: express.Response) {
    const programmeEpisodeId = parseInt(req.params.programmeEpisodeId)
    const partnerId = parseInt(req.params.partnerId)

    try {
        const modelRelation = await ProgrammeEpisode.createFollowsEpisodeRelationship(programmeEpisodeId, partnerId)
