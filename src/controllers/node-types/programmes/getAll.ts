...
export async function getAll(req: express.Request, res: express.Response) {
    try {
        const params = extractCollectionConstraintParameters(req, getNodeTypeSpecification(NodeType.Programme))
        ...
        const marshalledData = marshalNodeCollection(ControllerNodeType.Programme, nodes, params, totalAmount)
