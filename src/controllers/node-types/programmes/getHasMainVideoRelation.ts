...
export async function getHasMainVideoRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Programme.getHasMainVideoRelationship(programmeId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Programme, programmeId, RelationType.ProgrammeHasMainVideo)
            return sendResponse200(marshalledData, res)
        } else {
