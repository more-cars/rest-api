...
export async function getHasMainVideoRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await CarModel.getHasMainVideoRelationship(carModelId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.CarModel, carModelId, RelationType.CarModelHasMainVideo)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
