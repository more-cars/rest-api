...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await RacingEvent.getHasPrimeImageRelationship(racingEventId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.RacingEvent, racingEventId, RelationType.RacingEventHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
