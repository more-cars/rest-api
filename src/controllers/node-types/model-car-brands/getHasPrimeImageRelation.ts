...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await ModelCarBrand.getHasPrimeImageRelationship(modelCarBrandId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.ModelCarBrand, modelCarBrandId, RelationType.ModelCarBrandHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
