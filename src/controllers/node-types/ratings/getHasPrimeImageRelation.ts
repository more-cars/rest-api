...
export async function getHasPrimeImageRelation(req: express.Request, res: express.Response) {
    ...
    try {
        const modelRelation = await Rating.getHasPrimeImageRelationship(ratingId)
        ...
        if (e instanceof NodeNotFoundError) {
            ...
            const marshalledData = marshalEmptyRelation(ControllerNodeType.Rating, ratingId, RelationType.RatingHasPrimeImage)
            return sendResponse200(marshalledData, res)
        } else {
            console.error(e)
