...
exports.ensureValidRaceTrackExists = async function ensureValidRaceTrackExists() {
...
exports.createRaceTrack = async function createRaceTrack() {
    return submitPostRequest("/race-tracks", {
        name: 'Lausitzring',
    })
}

exports.getAllRaceTracks = async function getAllRaceTracks() {
    return submitGetRequest("/race-tracks")
}

exports.ensureRaceTrackHasLayoutRelationshipExists = async function ensureRaceTrackHasLayoutRelationshipExists() {
...
exports.createRaceTrackHasLayoutRelationship = async function createRaceTrackHasLayoutRelationship(raceTrackId, trackLayoutId) {
    return submitPostRequest("/race-tracks/" + raceTrackId + "/has-layout/" + trackLayoutId)
}

exports.ensureRaceTrackHasImageRelationshipExists = async function ensureRaceTrackHasImageRelationshipExists() {
    await this.ensureValidRaceTrackExists()
    await ensureValidImageExists()
    await this.createRaceTrackHasImageRelationship(bru.getEnvVar('validRaceTrackId'), bru.getEnvVar('validImageId'))
}

exports.createRaceTrackHasImageRelationship = async function createRaceTrackHasImageRelationship(raceTrackId, imageId) {
    return submitPostRequest("/race-tracks/" + raceTrackId + "/has-image/" + imageId)
}

exports.ensureRaceTrackHasPrimeImageRelationshipExists = async function ensureRaceTrackHasPrimeImageRelationshipExists() {
    await this.ensureValidRaceTrackExists()
    await ensureValidImageExists()
    await this.createRaceTrackHasPrimeImageRelationship(bru.getEnvVar('validRaceTrackId'), bru.getEnvVar('validImageId'))
}

exports.createRaceTrackHasPrimeImageRelationship = async function createRaceTrackHasPrimeImageRelationship(raceTrackId, imageId) {
    return submitPostRequest("/race-tracks/" + raceTrackId + "/has-prime-image/" + imageId)
}

exports.ensureRaceTrackHostedRacingEventRelationshipExists = async function ensureRaceTrackHostedRacingEventRelationshipExists() {
    await this.ensureValidRaceTrackExists()
...
exports.createRaceTrackHostedRacingEventRelationship = async function createRaceTrackHostedRacingEventRelationship(raceTrackId, racingEventId) {
