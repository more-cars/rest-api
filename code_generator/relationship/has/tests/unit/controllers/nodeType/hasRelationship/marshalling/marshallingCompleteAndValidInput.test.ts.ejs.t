---
to: tests/unit/controllers/<%= h.inflection.pluralize(h.changeCase.kebab(startNodeType)) %>/has<%= h.changeCase.pascal(relationshipName) %>Relationship/marshalling/marshallingCompleteAndValidInput.test.ts
---
