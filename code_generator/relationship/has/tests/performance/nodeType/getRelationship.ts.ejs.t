---
to: tests/performance/scenarios/<%= h.inflection.pluralize(h.changeCase.kebab(startNodeType)) %>/has-<%= h.changeCase.kebab(relationshipName) %>-relationship.ts
---
...
export const options = {
    ...
    scenarios: {
        has<%= h.changeCase.pascal(relationshipName) %>Relationship: {
