---
to: tests/unit/controllers/<%= h.inflection.pluralize(h.changeCase.kebab(startNodeType)) %>/create<%= h.changeCase.pascal(relationshipName) %>Relationship/marshalling/marshallingCompleteAndValidInput.test.ts
---
