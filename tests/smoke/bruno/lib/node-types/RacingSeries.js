...
exports.createHasVideoRelationship = async function () {
    await post("/racing-series/" + bru.getEnvVar('validRacingSeriesId') + "/has-video/" + bru.getEnvVar('validVideoId'))
}

exports.createHasMainVideoRelationship = async function () {
    await post("/racing-series/" + bru.getEnvVar('validRacingSeriesId') + "/has-main-video/" + bru.getEnvVar('validVideoId'))
}
