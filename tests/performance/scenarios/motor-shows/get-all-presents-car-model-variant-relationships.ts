...
export const options = {
    ...
    scenarios: {
        getAllPresentsCarModelVariantRelationships: {
...
export default function (data: { motorShowId: number }) {
    const url = `${__ENV.API_URL}/motor-shows/${data.motorShowId}/presents-car-model-variant`
