...
export const options = {
    ...
    scenarios: {
        createPresentsCarModelVariantRelationship: {
...
export default function (data: { motorShowId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/motor-shows/${data.motorShowId}/presents-car-model-variant/${data.carModelVariantId}`
