...
export const options = {
    ...
    scenarios: {
        deletePresentsCarModelVariantRelationship: {
...
export default function (data: { motorShowId: number, carModelVariantIds: number[] }) {
    const carModelVariantId = data.carModelVariantIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/motor-shows/${data.motorShowId}/presents-car-model-variant/${carModelVariantId}`
