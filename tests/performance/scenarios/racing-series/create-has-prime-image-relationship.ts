...
export default function (data: { racingSeriesId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/racing-series/${data.racingSeriesId}/has-prime-image/${data.imageId}`
