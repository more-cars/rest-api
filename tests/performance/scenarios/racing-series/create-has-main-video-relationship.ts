...
export default function (data: { racingSeriesId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/racing-series/${data.racingSeriesId}/has-main-video/${data.videoId}`
