...
export default function (data: { modelCarBrandId: number, imageIds: number[] }) {
    const imageId = data.imageIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/model-car-brands/${data.modelCarBrandId}/has-prime-image/${imageId}`
