...
export default function (data: { modelCarBrandId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/model-car-brands/${data.modelCarBrandId}/has-prime-image/${data.imageId}`
