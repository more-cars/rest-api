...
export const options = {
    ...
    scenarios: {
        createHasMainVideoRelationship: {
...
export default function (data: { modelCarBrandId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/model-car-brands/${data.modelCarBrandId}/has-main-video/${data.videoId}`
