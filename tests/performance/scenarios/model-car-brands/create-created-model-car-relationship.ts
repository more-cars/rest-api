...
export const options = {
    ...
    scenarios: {
        createCreatedModelCarRelationship: {
...
export default function (data: { modelCarBrandId: number, modelCarId: number }) {
    const url = `${__ENV.API_URL}/model-car-brands/${data.modelCarBrandId}/created-model-car/${data.modelCarId}`
