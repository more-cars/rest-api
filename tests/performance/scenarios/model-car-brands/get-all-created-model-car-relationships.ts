...
export const options = {
    ...
    scenarios: {
        getAllCreatedModelCarRelationships: {
...
export default function (data: { modelCarBrandId: number }) {
    const url = `${__ENV.API_URL}/model-car-brands/${data.modelCarBrandId}/created-model-car`
