...
export default function (data: { programmeId: number, programmeEpisodeId: number }) {
    const url = `${__ENV.API_URL}/programmes/${data.programmeId}/has-episode/${data.programmeEpisodeId}`
