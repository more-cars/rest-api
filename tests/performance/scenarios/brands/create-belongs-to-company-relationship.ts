...
export const options = {
    ...
    scenarios: {
        createBelongsToCompanyRelationship: {
...
export default function (data: { brandId: number, companyId: number }) {
    const url = `${__ENV.API_URL}/brands/${data.brandId}/belongs-to-company/${data.companyId}`
