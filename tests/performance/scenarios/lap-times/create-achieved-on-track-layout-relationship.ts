...
export const options = {
    ...
    scenarios: {
        createAchievedOnTrackLayoutRelationship: {
...
export default function (data: { lapTimeId: number, trackLayoutId: number }) {
    const url = `${__ENV.API_URL}/lap-times/${data.lapTimeId}/achieved-on-track-layout/${data.trackLayoutId}`
