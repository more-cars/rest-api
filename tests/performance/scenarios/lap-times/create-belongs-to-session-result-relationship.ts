...
export const options = {
    ...
    scenarios: {
        createBelongsToSessionResultRelationship: {
...
export default function (data: { lapTimeId: number, sessionResultId: number }) {
    const url = `${__ENV.API_URL}/lap-times/${data.lapTimeId}/belongs-to-session-result/${data.sessionResultId}`
