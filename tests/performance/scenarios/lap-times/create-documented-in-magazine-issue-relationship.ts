...
export const options = {
    ...
    scenarios: {
        createDocumentedInMagazineIssueRelationship: {
...
export default function (data: { lapTimeId: number, magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/lap-times/${data.lapTimeId}/documented-in-magazine-issue/${data.magazineIssueId}`
