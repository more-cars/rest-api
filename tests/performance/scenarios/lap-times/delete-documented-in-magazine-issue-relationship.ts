...
export const options = {
    ...
    scenarios: {
        deleteDocumentedInMagazineIssueRelationship: {
...
export default function (data: { lapTimeId: number, magazineIssueIds: number[] }) {
    const magazineIssueId = data.magazineIssueIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/lap-times/${data.lapTimeId}/documented-in-magazine-issue/${magazineIssueId}`
