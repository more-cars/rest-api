...
export const options = {
    ...
    scenarios: {
        deleteCoversCarModelVariantRelationship: {
...
export default function (data: { bookId: number, carModelVariantIds: number[] }) {
    const carModelVariantId = data.carModelVariantIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/books/${data.bookId}/covers-car-model-variant/${carModelVariantId}`
