...
export const options = {
    ...
    scenarios: {
        createCoversCarModelVariantRelationship: {
...
export default function (data: { bookId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/books/${data.bookId}/covers-car-model-variant/${data.carModelVariantId}`
