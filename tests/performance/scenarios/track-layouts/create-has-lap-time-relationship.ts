...
export default function (data: { trackLayoutId: number, lapTimeId: number }) {
    const url = `${__ENV.API_URL}/track-layouts/${data.trackLayoutId}/has-lap-time/${data.lapTimeId}`
