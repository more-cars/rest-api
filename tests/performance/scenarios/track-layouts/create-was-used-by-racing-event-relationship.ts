...
export const options = {
    ...
    scenarios: {
        createWasUsedByRacingEventRelationship: {
...
export default function (data: { trackLayoutId: number, racingEventId: number }) {
    const url = `${__ENV.API_URL}/track-layouts/${data.trackLayoutId}/was-used-by-racing-event/${data.racingEventId}`
