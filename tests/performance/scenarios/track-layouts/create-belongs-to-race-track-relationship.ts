...
export const options = {
    ...
    scenarios: {
        createBelongsToRaceTrackRelationship: {
...
export default function (data: { trackLayoutId: number, raceTrackId: number }) {
    const url = `${__ENV.API_URL}/track-layouts/${data.trackLayoutId}/belongs-to-race-track/${data.raceTrackId}`
