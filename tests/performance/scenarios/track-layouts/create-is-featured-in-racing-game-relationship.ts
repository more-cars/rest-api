...
export default function (data: { trackLayoutId: number, racingGameId: number }) {
    const url = `${__ENV.API_URL}/track-layouts/${data.trackLayoutId}/is-featured-in-racing-game/${data.racingGameId}`
