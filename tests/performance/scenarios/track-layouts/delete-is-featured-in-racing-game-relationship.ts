...
export default function (data: { trackLayoutId: number, racingGameIds: number[] }) {
    const racingGameId = data.racingGameIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/track-layouts/${data.trackLayoutId}/is-featured-in-racing-game/${racingGameId}`
