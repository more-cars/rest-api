...
export const options = {
    ...
    scenarios: {
        getAllReviewedCarModelVariantWithRatingRelationships: {
...
export default function (data: { magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/reviewed-car-model-variant-with-rating`
