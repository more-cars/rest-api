...
export default function (data: { magazineIssueId: number, videoIds: number[] }) {
    const videoId = data.videoIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/has-main-video/${videoId}`
