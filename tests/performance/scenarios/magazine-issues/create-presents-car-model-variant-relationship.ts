...
export default function (data: { magazineIssueId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/presents-car-model-variant/${data.carModelVariantId}`
