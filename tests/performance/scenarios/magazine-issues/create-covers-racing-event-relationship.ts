...
export const options = {
    ...
    scenarios: {
        createCoversRacingEventRelationship: {
...
export default function (data: { magazineIssueId: number, racingEventId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/covers-racing-event/${data.racingEventId}`
