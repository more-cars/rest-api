...
export const options = {
    ...
    scenarios: {
        createFollowedByIssueRelationship: {
...
export function setup() {
    ...
    const partnerId = createNode(ControllerNodeType.MagazineIssue)
...
export default function (data: { magazineIssueId: number, partnerId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/followed-by-issue/${data.partnerId}`
