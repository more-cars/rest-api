...
export const options = {
    ...
    scenarios: {
        deleteFollowedByIssueRelationship: {
...
export default function (data: { magazineIssueId: number, partnerIds: number[] }) {
    const partnerId = data.partnerIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/followed-by-issue/${partnerId}`
