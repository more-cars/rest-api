...
export default function (data: { magazineIssueId: number, carModelId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/covers-car-model/${data.carModelId}`
