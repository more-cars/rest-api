...
export const options = {
    ...
    scenarios: {
        createReviewedCarModelVariantWithRatingRelationship: {
...
export default function (data: { magazineIssueId: number, ratingId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/reviewed-car-model-variant-with-rating/${data.ratingId}`
