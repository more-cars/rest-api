...
export const options = {
    ...
    scenarios: {
        deleteDocumentsLapTimeRelationship: {
...
export default function (data: { magazineIssueId: number, lapTimeIds: number[] }) {
    const lapTimeId = data.lapTimeIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/documents-lap-time/${lapTimeId}`
