...
export const options = {
    ...
    scenarios: {
        deleteCoversRacingEventRelationship: {
...
export default function (data: { magazineIssueId: number, racingEventIds: number[] }) {
    const racingEventId = data.racingEventIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/covers-racing-event/${racingEventId}`
