...
export default function (data: { magazineIssueId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/has-prime-image/${data.imageId}`
