...
export const options = {
    ...
    scenarios: {
        createBelongsToMagazineRelationship: {
...
export default function (data: { magazineIssueId: number, magazineId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/belongs-to-magazine/${data.magazineId}`
