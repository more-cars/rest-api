...
export default function (data: { magazineIssueId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/has-main-video/${data.videoId}`
