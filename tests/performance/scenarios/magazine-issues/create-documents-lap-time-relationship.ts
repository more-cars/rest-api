...
export const options = {
    ...
    scenarios: {
        createDocumentsLapTimeRelationship: {
...
export default function (data: { magazineIssueId: number, lapTimeId: number }) {
    const url = `${__ENV.API_URL}/magazine-issues/${data.magazineIssueId}/documents-lap-time/${data.lapTimeId}`
