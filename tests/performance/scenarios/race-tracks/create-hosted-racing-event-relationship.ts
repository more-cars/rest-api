...
export const options = {
    ...
    scenarios: {
        createHostedRacingEventRelationship: {
...
export default function (data: { raceTrackId: number, racingEventId: number }) {
    const url = `${__ENV.API_URL}/race-tracks/${data.raceTrackId}/hosted-racing-event/${data.racingEventId}`
