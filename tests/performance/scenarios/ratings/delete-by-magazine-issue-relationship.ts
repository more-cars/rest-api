...
export const options = {
    ...
    scenarios: {
        deleteByMagazineIssueRelationship: {
...
export default function (data: { ratingId: number, magazineIssueIds: number[] }) {
    const magazineIssueId = data.magazineIssueIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/ratings/${data.ratingId}/by-magazine-issue/${magazineIssueId}`
