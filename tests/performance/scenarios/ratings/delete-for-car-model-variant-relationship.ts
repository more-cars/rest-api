...
export const options = {
    ...
    scenarios: {
        deleteForCarModelVariantRelationship: {
...
export default function (data: { ratingId: number, carModelVariantIds: number[] }) {
    const carModelVariantId = data.carModelVariantIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/ratings/${data.ratingId}/for-car-model-variant/${carModelVariantId}`
