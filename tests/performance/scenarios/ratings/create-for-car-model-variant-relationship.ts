...
export const options = {
    ...
    scenarios: {
        createForCarModelVariantRelationship: {
...
export default function (data: { ratingId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/ratings/${data.ratingId}/for-car-model-variant/${data.carModelVariantId}`
