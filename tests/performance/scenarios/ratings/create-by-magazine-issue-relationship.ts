...
export const options = {
    ...
    scenarios: {
        createByMagazineIssueRelationship: {
...
export default function (data: { ratingId: number, magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/ratings/${data.ratingId}/by-magazine-issue/${data.magazineIssueId}`
