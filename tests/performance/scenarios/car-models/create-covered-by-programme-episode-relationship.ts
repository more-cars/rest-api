...
export const options = {
    ...
    scenarios: {
        createCoveredByProgrammeEpisodeRelationship: {
...
export default function (data: { carModelId: number, programmeEpisodeId: number }) {
    const url = `${__ENV.API_URL}/car-models/${data.carModelId}/covered-by-programme-episode/${data.programmeEpisodeId}`
