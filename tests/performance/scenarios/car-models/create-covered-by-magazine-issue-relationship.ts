...
export default function (data: { carModelId: number, magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/car-models/${data.carModelId}/covered-by-magazine-issue/${data.magazineIssueId}`
