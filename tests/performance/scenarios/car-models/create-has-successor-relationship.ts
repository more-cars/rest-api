...
export const options = {
    ...
    scenarios: {
        createHasSuccessorRelationship: {
...
export default function (data: { carModelId: number, partnerId: number }) {
    const url = `${__ENV.API_URL}/car-models/${data.carModelId}/has-successor/${data.partnerId}`
