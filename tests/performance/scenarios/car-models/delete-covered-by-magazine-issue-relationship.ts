...
export default function (data: { carModelId: number, magazineIssueIds: number[] }) {
    const magazineIssueId = data.magazineIssueIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/car-models/${data.carModelId}/covered-by-magazine-issue/${magazineIssueId}`
