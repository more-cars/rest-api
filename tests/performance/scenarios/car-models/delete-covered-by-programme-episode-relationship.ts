...
export const options = {
    ...
    scenarios: {
        deleteCoveredByProgrammeEpisodeRelationship: {
...
export default function (data: { carModelId: number, programmeEpisodeIds: number[] }) {
    const programmeEpisodeId = data.programmeEpisodeIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/car-models/${data.carModelId}/covered-by-programme-episode/${programmeEpisodeId}`
