...
export const options = {
    ...
    scenarios: {
        getIsFollowedByEpisodeRelationship: {
...
export default function (data: { programmeEpisodeId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/is-followed-by-episode`
