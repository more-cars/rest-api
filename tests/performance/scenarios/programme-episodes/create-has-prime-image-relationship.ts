...
export default function (data: { programmeEpisodeId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/has-prime-image/${data.imageId}`
