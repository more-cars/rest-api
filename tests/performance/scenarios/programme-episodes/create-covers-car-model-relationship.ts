...
export const options = {
    ...
    scenarios: {
        createCoversCarModelRelationship: {
...
export default function (data: { programmeEpisodeId: number, carModelId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/covers-car-model/${data.carModelId}`
