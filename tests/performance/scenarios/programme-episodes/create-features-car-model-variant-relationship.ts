...
export const options = {
    ...
    scenarios: {
        createFeaturesCarModelVariantRelationship: {
...
export default function (data: { programmeEpisodeId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/features-car-model-variant/${data.carModelVariantId}`
