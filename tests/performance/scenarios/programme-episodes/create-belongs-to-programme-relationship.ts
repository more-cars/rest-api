...
export const options = {
    ...
    scenarios: {
        createBelongsToProgrammeRelationship: {
...
export default function (data: { programmeEpisodeId: number, programmeId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/belongs-to-programme/${data.programmeId}`
