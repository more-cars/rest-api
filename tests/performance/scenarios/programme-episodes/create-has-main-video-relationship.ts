...
export default function (data: { programmeEpisodeId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/has-main-video/${data.videoId}`
