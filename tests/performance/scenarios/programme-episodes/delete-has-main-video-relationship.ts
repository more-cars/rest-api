...
export default function (data: { programmeEpisodeId: number, videoIds: number[] }) {
    const videoId = data.videoIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/has-main-video/${videoId}`
