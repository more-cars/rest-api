...
export const options = {
    ...
    scenarios: {
        createIsFollowedByEpisodeRelationship: {
...
export function setup() {
    ...
    const partnerId = createNode(ControllerNodeType.ProgrammeEpisode)
...
export default function (data: { programmeEpisodeId: number, partnerId: number }) {
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/is-followed-by-episode/${data.partnerId}`
