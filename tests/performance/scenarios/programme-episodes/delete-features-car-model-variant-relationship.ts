...
export const options = {
    ...
    scenarios: {
        deleteFeaturesCarModelVariantRelationship: {
...
export default function (data: { programmeEpisodeId: number, carModelVariantIds: number[] }) {
    const carModelVariantId = data.carModelVariantIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/programme-episodes/${data.programmeEpisodeId}/features-car-model-variant/${carModelVariantId}`
