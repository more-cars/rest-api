...
export const options = {
    ...
    scenarios: {
        createFeaturesRacingGameRelationship: {
...
export default function (data: { gamingPlatformId: number, racingGameId: number }) {
    const url = `${__ENV.API_URL}/gaming-platforms/${data.gamingPlatformId}/features-racing-game/${data.racingGameId}`
