...
export default function (data: { gamingPlatformId: number, videoIds: number[] }) {
    const videoId = data.videoIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/gaming-platforms/${data.gamingPlatformId}/has-main-video/${videoId}`
