...
export default function (data: { gamingPlatformId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/gaming-platforms/${data.gamingPlatformId}/has-main-video/${data.videoId}`
