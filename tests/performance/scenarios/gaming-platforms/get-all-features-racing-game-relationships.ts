...
export const options = {
    ...
    scenarios: {
        getAllFeaturesRacingGameRelationships: {
...
export default function (data: { gamingPlatformId: number }) {
    const url = `${__ENV.API_URL}/gaming-platforms/${data.gamingPlatformId}/features-racing-game`
