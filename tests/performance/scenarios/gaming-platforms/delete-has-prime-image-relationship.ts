...
export default function (data: { gamingPlatformId: number, imageIds: number[] }) {
    const imageId = data.imageIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/gaming-platforms/${data.gamingPlatformId}/has-prime-image/${imageId}`
