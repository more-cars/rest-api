...
export const options = {
    ...
    scenarios: {
        getMadeByModelCarBrandRelationship: {
...
export default function (data: { modelCarId: number }) {
    const url = `${__ENV.API_URL}/model-cars/${data.modelCarId}/made-by-model-car-brand`
