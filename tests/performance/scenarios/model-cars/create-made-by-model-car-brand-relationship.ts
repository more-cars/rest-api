...
export const options = {
    ...
    scenarios: {
        createMadeByModelCarBrandRelationship: {
...
export default function (data: { modelCarId: number, modelCarBrandId: number }) {
    const url = `${__ENV.API_URL}/model-cars/${data.modelCarId}/made-by-model-car-brand/${data.modelCarBrandId}`
