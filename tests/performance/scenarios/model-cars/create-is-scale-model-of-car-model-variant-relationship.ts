...
export const options = {
    ...
    scenarios: {
        createIsScaleModelOfCarModelVariantRelationship: {
...
export default function (data: { modelCarId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/model-cars/${data.modelCarId}/is-scale-model-of-car-model-variant/${data.carModelVariantId}`
