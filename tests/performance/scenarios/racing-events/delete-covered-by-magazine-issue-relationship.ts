...
export const options = {
    ...
    scenarios: {
        deleteCoveredByMagazineIssueRelationship: {
...
export default function (data: { racingEventId: number, magazineIssueIds: number[] }) {
    const magazineIssueId = data.magazineIssueIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/covered-by-magazine-issue/${magazineIssueId}`
