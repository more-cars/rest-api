...
export const options = {
    ...
    scenarios: {
        createCoveredByMagazineIssueRelationship: {
...
export default function (data: { racingEventId: number, magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/covered-by-magazine-issue/${data.magazineIssueId}`
