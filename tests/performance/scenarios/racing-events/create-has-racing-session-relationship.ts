...
export const options = {
    ...
    scenarios: {
        createHasRacingSessionRelationship: {
...
export default function (data: { racingEventId: number, racingSessionId: number }) {
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/has-racing-session/${data.racingSessionId}`
