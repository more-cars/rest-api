...
export const options = {
    ...
    scenarios: {
        createTookPlaceAtRaceTrackRelationship: {
...
export default function (data: { racingEventId: number, raceTrackId: number }) {
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/took-place-at-race-track/${data.raceTrackId}`
