...
export const options = {
    ...
    scenarios: {
        createBelongsToRacingSeriesRelationship: {
...
export default function (data: { racingEventId: number, racingSeriesId: number }) {
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/belongs-to-racing-series/${data.racingSeriesId}`
