...
export const options = {
    ...
    scenarios: {
        createIsFollowedByEventRelationship: {
...
export function setup() {
    ...
    const partnerId = createNode(ControllerNodeType.RACING_EVENT)
...
export default function (data: { racingEventId: number, partnerId: number }) {
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/is-followed-by-event/${data.partnerId}`
