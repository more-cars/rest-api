...
export const options = {
    ...
    scenarios: {
        deleteTookPlaceAtRaceTrackRelationship: {
...
export default function (data: { racingEventId: number, raceTrackIds: number[] }) {
    const raceTrackId = data.raceTrackIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/racing-events/${data.racingEventId}/took-place-at-race-track/${raceTrackId}`
