...
export default function (data: { racingSessionId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/has-main-video/${data.videoId}`
