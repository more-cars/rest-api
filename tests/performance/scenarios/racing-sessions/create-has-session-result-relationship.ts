...
export const options = {
    ...
    scenarios: {
        createHasSessionResultRelationship: {
...
export default function (data: { racingSessionId: number, sessionResultId: number }) {
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/has-session-result/${data.sessionResultId}`
