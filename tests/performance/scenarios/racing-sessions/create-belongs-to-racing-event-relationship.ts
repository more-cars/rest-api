...
export const options = {
    ...
    scenarios: {
        createBelongsToRacingEventRelationship: {
...
export default function (data: { racingSessionId: number, racingEventId: number }) {
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/belongs-to-racing-event/${data.racingEventId}`
