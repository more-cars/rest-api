...
export const options = {
    ...
    scenarios: {
        getBelongsToRacingEventRelationship: {
...
export default function (data: { racingSessionId: number }) {
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/belongs-to-racing-event`
