...
export default function (data: { racingSessionId: number, videoIds: number[] }) {
    const videoId = data.videoIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/has-main-video/${videoId}`
