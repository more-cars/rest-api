...
export default function (data: { racingSessionId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/racing-sessions/${data.racingSessionId}/has-prime-image/${data.imageId}`
