...
export const options = {
    ...
    scenarios: {
        deleteFeaturesTrackLayoutRelationship: {
...
export default function (data: { racingGameId: number, trackLayoutIds: number[] }) {
    const trackLayoutId = data.trackLayoutIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/racing-games/${data.racingGameId}/features-track-layout/${trackLayoutId}`
