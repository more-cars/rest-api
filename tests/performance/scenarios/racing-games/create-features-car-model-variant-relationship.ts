...
export default function (data: { racingGameId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/racing-games/${data.racingGameId}/features-car-model-variant/${data.carModelVariantId}`
