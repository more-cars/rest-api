...
export const options = {
    ...
    scenarios: {
        createFeaturesTrackLayoutRelationship: {
...
export default function (data: { racingGameId: number, trackLayoutId: number }) {
    const url = `${__ENV.API_URL}/racing-games/${data.racingGameId}/features-track-layout/${data.trackLayoutId}`
