...
export const options = {
    ...
    scenarios: {
        getAllReleasedOnGamingPlatformRelationships: {
...
export default function (data: { racingGameId: number }) {
    const url = `${__ENV.API_URL}/racing-games/${data.racingGameId}/released-on-gaming-platform`
