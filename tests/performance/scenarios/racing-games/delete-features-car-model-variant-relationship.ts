...
export default function (data: { racingGameId: number, carModelVariantIds: number[] }) {
    const carModelVariantId = data.carModelVariantIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/racing-games/${data.racingGameId}/features-car-model-variant/${carModelVariantId}`
