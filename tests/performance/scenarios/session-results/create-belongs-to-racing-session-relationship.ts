...
export const options = {
    ...
    scenarios: {
        createBelongsToRacingSessionRelationship: {
...
export default function (data: { sessionResultId: number, racingSessionId: number }) {
    const url = `${__ENV.API_URL}/session-results/${data.sessionResultId}/belongs-to-racing-session/${data.racingSessionId}`
