...
export default function (data: { sessionResultId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/session-results/${data.sessionResultId}/achieved-with-car-model-variant/${data.carModelVariantId}`
