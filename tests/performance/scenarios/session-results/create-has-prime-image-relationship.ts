...
export default function (data: { sessionResultId: number, imageId: number }) {
    const url = `${__ENV.API_URL}/session-results/${data.sessionResultId}/has-prime-image/${data.imageId}`
