...
export default function (data: { sessionResultId: number, lapTimeId: number }) {
    const url = `${__ENV.API_URL}/session-results/${data.sessionResultId}/has-lap-time/${data.lapTimeId}`
