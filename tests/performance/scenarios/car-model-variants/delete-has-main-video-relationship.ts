...
export default function (data: { carModelVariantId: number, videoIds: number[] }) {
    const videoId = data.videoIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/has-main-video/${videoId}`
