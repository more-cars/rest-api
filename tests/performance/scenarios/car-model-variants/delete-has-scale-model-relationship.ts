...
export const options = {
    ...
    scenarios: {
        deleteHasScaleModelRelationship: {
...
export default function (data: { carModelVariantId: number, modelCarIds: number[] }) {
    const modelCarId = data.modelCarIds[exec.scenario.iterationInTest]
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/has-scale-model/${modelCarId}`
