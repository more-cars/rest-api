...
export const options = {
    ...
    scenarios: {
        createIsCoveredByBookRelationship: {
...
export default function (data: { carModelVariantId: number, bookId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/is-covered-by-book/${data.bookId}`
