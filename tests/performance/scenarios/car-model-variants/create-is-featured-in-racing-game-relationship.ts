...
export const options = {
    ...
    scenarios: {
        createIsFeaturedInRacingGameRelationship: {
...
export default function (data: { carModelVariantId: number, racingGameId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/is-featured-in-racing-game/${data.racingGameId}`
