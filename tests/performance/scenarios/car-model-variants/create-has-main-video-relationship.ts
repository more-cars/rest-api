...
export default function (data: { carModelVariantId: number, videoId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/has-main-video/${data.videoId}`
