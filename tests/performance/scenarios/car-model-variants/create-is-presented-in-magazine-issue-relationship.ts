...
export const options = {
    ...
    scenarios: {
        createIsPresentedInMagazineIssueRelationship: {
...
export default function (data: { carModelVariantId: number, magazineIssueId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/is-presented-in-magazine-issue/${data.magazineIssueId}`
