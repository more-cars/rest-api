...
export const options = {
    ...
    scenarios: {
        createPresentedAtMotorShowRelationship: {
...
export default function (data: { carModelVariantId: number, motorShowId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/presented-at-motor-show/${data.motorShowId}`
