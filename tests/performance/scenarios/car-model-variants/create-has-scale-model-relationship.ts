...
export const options = {
    ...
    scenarios: {
        createHasScaleModelRelationship: {
...
export default function (data: { carModelVariantId: number, modelCarId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/has-scale-model/${data.modelCarId}`
