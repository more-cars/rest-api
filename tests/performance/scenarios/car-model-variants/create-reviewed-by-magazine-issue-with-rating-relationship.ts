...
export const options = {
    ...
    scenarios: {
        createReviewedByMagazineIssueWithRatingRelationship: {
...
export function setup() {
    ...
    const ratingId = createNode(ControllerNodeType.Rating)
...
export default function (data: { carModelVariantId: number, ratingId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/reviewed-by-magazine-issue-with-rating/${data.ratingId}`
