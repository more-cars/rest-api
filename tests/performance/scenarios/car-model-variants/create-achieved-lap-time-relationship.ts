...
export const options = {
    ...
    scenarios: {
        createAchievedLapTimeRelationship: {
...
export default function (data: { carModelVariantId: number, lapTimeId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/achieved-lap-time/${data.lapTimeId}`
