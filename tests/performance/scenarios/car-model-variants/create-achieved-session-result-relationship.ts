...
export const options = {
    ...
    scenarios: {
        createAchievedSessionResultRelationship: {
...
export default function (data: { carModelVariantId: number, sessionResultId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/achieved-session-result/${data.sessionResultId}`
