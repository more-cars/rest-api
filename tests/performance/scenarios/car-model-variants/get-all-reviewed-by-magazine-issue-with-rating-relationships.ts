...
export const options = {
    ...
    scenarios: {
        getAllReviewedByMagazineIssueWithRatingRelationships: {
...
export default function (data: { carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/reviewed-by-magazine-issue-with-rating`
