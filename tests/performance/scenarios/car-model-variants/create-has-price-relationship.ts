...
export default function (data: { carModelVariantId: number, priceId: number }) {
    const url = `${__ENV.API_URL}/car-model-variants/${data.carModelVariantId}/has-price/${data.priceId}`
