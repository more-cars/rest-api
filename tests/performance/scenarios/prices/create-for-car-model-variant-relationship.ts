...
export default function (data: { priceId: number, carModelVariantId: number }) {
    const url = `${__ENV.API_URL}/prices/${data.priceId}/for-car-model-variant/${data.carModelVariantId}`
