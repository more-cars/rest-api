...
test('Expecting response "false" when trying to delete a non-existing MOTOR SHOW', async () => {
...
test('Expecting response "true" when deleting an existing MOTOR SHOW', async () => {
