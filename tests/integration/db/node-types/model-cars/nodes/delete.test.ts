...
test('Expecting response "false" when trying to delete a non-existing MODEL CAR', async () => {
...
test('Expecting response "true" when deleting an existing MODEL CAR', async () => {
