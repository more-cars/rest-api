...
test('Expecting response "false" when trying to delete a non-existing PROGRAMME EPISODE', async () => {
...
test('Expecting response "true" when deleting an existing PROGRAMME EPISODE', async () => {
