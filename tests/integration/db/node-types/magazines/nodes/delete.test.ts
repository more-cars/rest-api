...
test('Expecting response "false" when trying to delete a non-existing MAGAZINE', async () => {
...
test('Expecting response "true" when deleting an existing MAGAZINE', async () => {
