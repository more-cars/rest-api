...
test('Expecting response "false" when trying to delete a non-existing PROGRAMME', async () => {
...
test('Expecting response "true" when deleting an existing PROGRAMME', async () => {
