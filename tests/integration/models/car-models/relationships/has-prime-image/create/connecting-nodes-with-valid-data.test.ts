...
test('Creating a ›has-prime-image‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await CarModel.createHasPrimeImageRelationship(carModel.properties.id, image.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.CarModelHasPrimeImage)
