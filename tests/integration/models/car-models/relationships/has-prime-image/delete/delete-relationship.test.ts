...
describe('Deleting a ›has-prime-image‹ relationship', () => {
    ...
    test('both nodes exist and have a ›has-prime-image‹ relationship', async () => {
        const seededRelationship = await seedRelationship(NodeTypeEnum.CAR_MODEL, NodeTypeEnum.IMAGE, RelationshipType.CarModelHasPrimeImage)
        ...
        await CarModel.deleteHasPrimeImageRelationship(seededRelationship.start_node.id, seededRelationship.end_node.id)
