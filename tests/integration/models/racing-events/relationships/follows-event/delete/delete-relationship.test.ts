...
describe('Deleting a ›follows-event‹ relationship', () => {
    ...
    test('both nodes exist and have a ›follows-event‹ relationship', async () => {
        const seededRelationship = await seedRelationship(DbNodeType.RacingEvent, DbNodeType.RacingEvent, RelationshipType.RacingEventFollowsEvent)
        ...
        await RacingEvent.deleteFollowsEventRelationship(seededRelationship.start_node.properties.id, seededRelationship.end_node.properties.id)
