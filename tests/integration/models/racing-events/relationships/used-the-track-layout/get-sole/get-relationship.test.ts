...
describe('Requesting a ›used-the-track-layout‹ relationship', () => {
    test('node and relationship exist', async () => {
        const expectedRelationship = await seedRelationship(NodeTypeEnum.RACING_EVENT, NodeTypeEnum.TRACK_LAYOUT, DbRelationship.RacingEventUsedTheTrackLayout)
        const actualRelationship = await RacingEvent.getUsedTheTrackLayoutRelationship(expectedRelationship.start_node_id)
