...
test('Unknown properties are ignored', async () => {
    ...
    // CAR MODEL
    const carModelData = Object.assign({}, getExhaustiveFakeInputDataForDbNode(DbNodeType.CarModel) as InputCarModelCreate, {
    ...
    // BRAND
    const brandData = Object.assign({}, getExhaustiveFakeInputDataForDbNode(DbNodeType.Brand) as InputBrandCreate, {
        "my_property": "NOT_ALLOWED_TO_ADD"
    })
    ...
    // IMAGE
    const imageData = Object.assign({}, getExhaustiveFakeInputDataForDbNode(DbNodeType.Image) as InputImageCreate, {
        "my_property": "NOT_ALLOWED_TO_ADD"
    })
