...
describe('Deleting a ›has-prime-image‹ relationship', () => {
    ...
    test('both nodes exist and have a ›has-prime-image‹ relationship', async () => {
        const seededRelationship = await seedRelationship(NodeTypeEnum.RACE_TRACK, NodeTypeEnum.IMAGE, RelationshipType.RaceTrackHasPrimeImage)
        ...
        await RaceTrack.deleteHasPrimeImageRelationship(seededRelationship.start_node.id, seededRelationship.end_node.id)
