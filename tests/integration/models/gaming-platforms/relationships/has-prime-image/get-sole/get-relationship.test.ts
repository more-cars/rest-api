...
describe('Requesting a ›has-prime-image‹ relationship', () => {
    test('node and relationship exist', async () => {
        const expectedRelationship = await seedRelationship(NodeTypeEnum.GAMING_PLATFORM, NodeTypeEnum.IMAGE, DbRelationship.GamingPlatformHasPrimeImage, REL.FORWARD)
        const expectedGamingPlatformId = expectedRelationship.start_node_id
