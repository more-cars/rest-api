...
describe('Requesting a ›has-prime-image‹ relationship', () => {
    test('node and relationship exist', async () => {
        const expectedRelationship = await seedRelationship(NodeTypeEnum.RACING_GAME, NodeTypeEnum.IMAGE, DbRelationship.RacingGameHasPrimeImage)
        const actualRelationship = await RacingGame.getHasPrimeImageRelationship(expectedRelationship.start_node_id)
