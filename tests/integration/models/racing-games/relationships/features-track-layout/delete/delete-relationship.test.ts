...
describe('Deleting a ›features-track-layout‹ relationship', () => {
    ...
    test('TRACK LAYOUT node does not exist', async () => {
        const trackLayout = await seedNode(NodeTypeEnum.RACING_GAME)
    ...
    test('both nodes exist and have a ›features-track-layout‹ relationship', async () => {
        ...
        await RacingGame.deleteFeaturesTrackLayoutRelationship(seededRelationship.start_node_id, seededRelationship.end_node_id)
