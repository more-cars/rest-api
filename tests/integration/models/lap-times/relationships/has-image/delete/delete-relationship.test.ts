...
describe('Deleting a ›has-image‹ relationship', () => {
    ...
    test('IMAGE node does not exist', async () => {
        const image = await seedNode(NodeTypeEnum.LAP_TIME)
    ...
    test('both nodes exist and have a ›has-image‹ relationship', async () => {
        const seededRelationship = await seedRelationship(NodeTypeEnum.LAP_TIME, NodeTypeEnum.IMAGE, DbRelationship.LapTimeHasImage)
