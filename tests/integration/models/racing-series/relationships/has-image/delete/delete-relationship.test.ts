...
describe('Deleting a ›has-image‹ relationship', () => {
    ...
    test('both nodes exist and have a ›has-image‹ relationship', async () => {
        const seededRelationship = await seedRelationship(NodeTypeEnum.RACING_SERIES, NodeTypeEnum.IMAGE, DbRelationship.RacingSeriesHasImage)
        ...
        await RacingSeries.deleteHasImageRelationship(seededRelationship.start_node_id, seededRelationship.end_node_id)
