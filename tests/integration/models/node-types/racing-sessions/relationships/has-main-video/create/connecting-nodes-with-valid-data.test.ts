...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await RacingSession.createHasMainVideoRelationship(racingSession.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.RacingSessionHasMainVideo)
