...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await ModelCar.createHasMainVideoRelationship(modelCar.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.ModelCarHasMainVideo)
