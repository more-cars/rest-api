...
test('Creating a ›has-prime-image‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await ModelCarBrand.createHasPrimeImageRelationship(modelCarBrand.properties.id, image.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.ModelCarBrandHasPrimeImage)
