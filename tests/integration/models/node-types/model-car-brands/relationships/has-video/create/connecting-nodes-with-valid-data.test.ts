...
test('Creating a ›has-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await ModelCarBrand.createHasVideoRelationship(modelCarBrand.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.ModelCarBrandHasVideo)
