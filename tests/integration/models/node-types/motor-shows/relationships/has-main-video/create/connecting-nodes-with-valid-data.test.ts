...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await MotorShow.createHasMainVideoRelationship(motorShow.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.MotorShowHasMainVideo)
