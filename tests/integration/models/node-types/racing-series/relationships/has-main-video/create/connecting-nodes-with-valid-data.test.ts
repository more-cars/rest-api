...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await RacingSeries.createHasMainVideoRelationship(racingSeries.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.RacingSeriesHasMainVideo)
