...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await RacingGame.createHasMainVideoRelationship(racingGame.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.RacingGameHasMainVideo)
