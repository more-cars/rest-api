...
test('Creating a ›has-main-video‹ relationship with valid data', async () => {
    ...
    const createdRelationship = await GamingPlatform.createHasMainVideoRelationship(gamingPlatform.properties.id, video.properties.id)
    ...
    expect(createdRelationship.type)
        .toEqual(RelType.GamingPlatformHasMainVideo)
