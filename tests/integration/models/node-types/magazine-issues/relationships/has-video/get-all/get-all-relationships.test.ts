...
describe('Requesting all ›has-video‹ relationships', () => {
    test('node and relationships exist', async () => {
        ...
        const relationships = await MagazineIssue.getAllHasVideoRelationships(magazineIssue.properties.id)
    ...
    test('neither node, nor relationships exist', async () => {
        await expect(MagazineIssue.getAllHasVideoRelationships(-42))
            .rejects
