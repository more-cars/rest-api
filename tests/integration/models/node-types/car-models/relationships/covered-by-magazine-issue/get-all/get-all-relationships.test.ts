...
describe('Requesting all ›covered-by-magazine-issue‹ relationships', () => {
    test('node and relationships exist', async () => {
        ...
        const relationships = await CarModel.getAllCoveredByMagazineIssueRelationships(carModel.properties.id)
    ...
    test('neither node, nor relationships exist', async () => {
        await expect(CarModel.getAllCoveredByMagazineIssueRelationships(-42))
            .rejects
