...
describe('A paginated "get all PROGRAMME EPISODE nodes" request returns the correct number of nodes', () => {
    test('when there exist no PROGRAMME EPISODE nodes', async () => {
        ...
        const actualNodes = await ProgrammeEpisode.findAll({page: 1})
