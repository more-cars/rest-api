...
describe('Requesting all ›is-covered-by-book‹ relationships', () => {
    test('node and relationships exist', async () => {
        ...
        const relationships = await CarModelVariant.getAllIsCoveredByBookRelationships(carModelVariant.properties.id)
    ...
    test('neither node, nor relationships exist', async () => {
        await expect(CarModelVariant.getAllIsCoveredByBookRelationships(-42))
            .rejects
