...
describe('Requesting all ›featured-in-programme-episode‹ relationships', () => {
    test('node and relationships exist', async () => {
        ...
        const relationships = await CarModelVariant.getAllFeaturedInProgrammeEpisodeRelationships(carModelVariant.properties.id)
    ...
    test('neither node, nor relationships exist', async () => {
        await expect(CarModelVariant.getAllFeaturedInProgrammeEpisodeRelationships(-42))
            .rejects
