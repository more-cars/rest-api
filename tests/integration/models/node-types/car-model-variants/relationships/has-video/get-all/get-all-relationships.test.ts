...
describe('Requesting all ›has-video‹ relationships', () => {
    test('node and relationships exist', async () => {
        ...
        const relationships = await CarModelVariant.getAllHasVideoRelationships(carModelVariant.properties.id)
    ...
    test('neither node, nor relationships exist', async () => {
        await expect(CarModelVariant.getAllHasVideoRelationships(-42))
            .rejects
