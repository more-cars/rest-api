...
vi.mock("../../../../src/controllers/node-types/RacingGameController.ts", {spy: true})
...
describe('Racing Games', () => {
    ...
    test('Get all ›has-video‹ relationships', async () => {
        ...
        expect(RacingGameController.getAllHasVideoRelations)
            .toHaveBeenCalledTimes(1)
    })
    ...
    test('Get ›has-main-video‹ relationship', async () => {
        ...
        expect(RacingGameController.getHasMainVideoRelation)
            .toHaveBeenCalledTimes(1)
    })
