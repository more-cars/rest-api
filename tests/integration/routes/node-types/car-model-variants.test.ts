...
describe('Car Model Variants', () => {
    ...
    test('Update Node', async () => {
        await request(app)
            .patch('/car-model-variants/123')

        expect(CarModelVariantController.update)
            .toHaveBeenCalledTimes(1)
    })
    ...
    test('Get all ›has-scale-model‹ relationships', async () => {
        await request(app)
            .get('/car-model-variants/123/has-scale-model')

        expect(CarModelVariantController.getAllHasScaleModelRelations)
            .toHaveBeenCalledTimes(1)
    })
    ...
    test('Get all ›is-covered-by-book‹ relationships', async () => {
        await request(app)
            .get('/car-model-variants/123/is-covered-by-book')

        expect(CarModelVariantController.getAllIsCoveredByBookRelations)
            .toHaveBeenCalledTimes(1)
    })
    ...
    test('Get all ›has-video‹ relationships', async () => {
        ...
        expect(CarModelVariantController.getAllHasVideoRelations)
            .toHaveBeenCalledTimes(1)
    })
    ...
    test('Get ›has-main-video‹ relationship', async () => {
        ...
        expect(CarModelVariantController.getHasMainVideoRelation)
            .toHaveBeenCalledTimes(1)
    })
