...
describe('Requesting the ›has-prime-image‹ relationship', () => {
    test('Providing valid data', async () => {
        ModelCarBrand.getHasPrimeImageRelationship = vi.fn().mockReturnValue(getFakeRel(RelType.ModelCarBrandHasPrimeImage))
    ...
    test('Providing valid data, but no relationships exist', async () => {
        vi.spyOn(ModelCarBrand, 'getHasPrimeImageRelationship')
