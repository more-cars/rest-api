...
test("marshalling a collection of ›has-car-model‹ relationships", async () => {
    ...
    const marshalledRelationships = marshalRelationships(relationships as BaseRelationship[], "car model")
